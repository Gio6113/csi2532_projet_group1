...
<body>
    ...
    echo '
        <h2> Here is a list of all your upcoming appointments. Be sure to attend them :)</h2>
    ';
        ...
        <tr>
            ...
            WHERE BB.user_id = ".$_SESSION["loggedin"]. "AND A.status ='normal'
            ...
            echo '</table><br><br> <h2> Here is a list of all your previous or rejected or canceled appointments</h2>';
