...
VALUES
	...
	(26,'Christine','Aguilera','Christine Aguilera','voice22','voice22','employee','1976-02-23',46),
	(27,'Jean','Lafleur','Jean Lafleur','jean2dentist','jean2dentist','employee','1975-02-24',47),
	(28,'Martha','Poliski','Martha Poliski','polisher1','polisher1','employee','1974-02-19',48),
	(29,'Emmanuel','Macaron','Emmanuel Macaron','GiletJaune12','GiletJaune12','employee','1973-02-08',49),
	(30,'Mia','Turner','Mia Turner','worker4ever','worker4ever','employee','1962-02-09',60),
	(31,'Michael','Godfrey','Michael Godfrey','Miketooth24','Miketooth24','employee','1952-02-22',70),
	(32,'Zinedine','Zidane','Zinedine Zidane','bluetooth13','siuuu22','employee','1950-07-13',71)
;
